    ...
    <?php require_once 'navbar.php' ?>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div class="card rounded-0">
            ...
            <div class="card-body ">
              <form class="form ajaxform" action="updates.php" method="post">
                <div class="form-group">
                  <label for="username">Username</label>
                  <input type="text" name="username" class="form-control rounded-0" value="<?php echo $db->real_escape_string(trim($username)) ?>" required>
                </div>
                <div class="form-group">
                  <label for="username">Name</label>
                  <input type="text" name="name" class="form-control rounded-0" value="<?php echo $db->real_escape_string(trim($name)) ?>" required>
                </div>
